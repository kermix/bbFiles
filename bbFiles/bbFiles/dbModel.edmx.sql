...
-- --------------------------------------------------
-- Date Created: 07/26/2017 18:45:19
-- Generated from EDMX file: C:\Users\kermax\Source\Repos\bbFiles\bbFiles\bbFiles\dbModel.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_dbo_Acceptors_dbo_Users_UserId]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Acceptors] DROP CONSTRAINT [FK_dbo_Acceptors_dbo_Users_UserId];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_dbo_Users_dbo_Acceptors_AcceptorId]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Users] DROP CONSTRAINT [FK_dbo_Users_dbo_Acceptors_AcceptorId];
GO
